            ...
            <div class="flex">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Values</li>
                    </ol>
                </nav>
                <h1 class="m-0">Edit Values</h1>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('dashboard.value.update', $value->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                @enderror
                                <div class="mt-2">
                                    <img src="{{ asset('storage/value/' . $value->banner) }}" id="show_img" alt=""
                                        width="100">
                                </div>
                            </div>
                            <div class="form-group">
