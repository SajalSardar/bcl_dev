        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('dashboard.home-about.update', $about->id) }}" method="POST"
                            ...
                            <div class="form-group ">
                                ...
                                <textarea name="description" class="form-control mb-2" rows="8" placeholder="description">{{ $about->description }}</textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="bottom_title" class="form-control mb-2"
                                    placeholder="Year Bottom Title" value="{{ $about->year_bottom_title }}">
                            </div>
