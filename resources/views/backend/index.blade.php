                    ...
                    <div class="card-body">
                        <a href="#">
                            <svg viewBox="0 0 16 16" width="30%" style="fill: currentColor;"
                                xmlns="http://www.w3.org/2000/svg" clip-rule="evenodd" stroke-linejoin="round"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 py-2">
                        <div
                            ...
                            <div class="flex">
                                <h5 class="card-title mb-1"><a href="" class="headings-color">DevOps Basics</a>
                                </h5>
                                <p class="text-muted mb-2">
        ...
        <div class="card-deck card-margin">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <div class="avatar avatar-sm mr-3">
                            <img src="assets/images/avatars/andrew-robles-300868.jpg" class="avatar-img rounded-circle"
                                alt="">
                        </div>
                ...
                <div class="card-footer d-flex justify-content-between">
                    <a href="#" class="text-social text-facebook">
                        <svg viewBox="0 0 16 16" width="20%" xmlns="http://www.w3.org/2000/svg" clip-rule="evenodd"
            ...
            <div class="card dashboard-chat">
                ...
                <div class="d-flex dashboard-chat__head">
                    <div class="avatar avatar-sm mr-3">
                        <img src="assets/images/avatars/lucas-sankey-378674.jpg" class="avatar-img rounded-circle"
                            alt="">
                    </div>
                    <div class="flex">
                    ...
                    <div class="dropdown">
                        <a class="dropdown-toggle btn btn-white btn-sm text-muted" href="#" id="chatSettings"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-caret="false">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="media align-items-center mb-3">
                        <img src="assets/images/avatars/lucas-sankey-378674.jpg" class="img-fluid rounded-circle mr-2"
                            width="35" alt="">
                    ...
                    <div class="input-group input-group-merge mt-auto">
                        <input type="text" class="form-control form-control-prepended" name="chat-message"
